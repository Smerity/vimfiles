...
"    highlight default level16c  ctermfg=red          guibg=AliceBlue    guifg=firebrick3
    ...
    highlight default level9c   ctermfg=gray         guibg=LemonChiffon guifg=RoyalBlue3
    highlight default level10c  ctermfg=black        guibg=LemonChiffon guifg=SeaGreen3
    highlight default level11c  ctermfg=darkred      guibg=LemonChiffon guifg=DarkOrchid3
    highlight default level12c  ctermfg=Darkblue     guibg=LemonChiffon guifg=firebrick3
    highlight default level13c  ctermfg=darkgreen    guibg=AliceBlue    guifg=RoyalBlue3
    highlight default level14c  ctermfg=darkcyan     guibg=AliceBlue    guifg=SeaGreen3
    highlight default level15c  ctermfg=darkmagenta      guibg=AliceBlue    guifg=DarkOrchid3
    highlight default level16c  ctermfg=red          guibg=AliceBlue    guifg=firebrick3
